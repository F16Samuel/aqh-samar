...
import { Target, Users, LogOut, User } from 'lucide-react'
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <div
              style={{
                ...
                background: 'linear-gradient(135deg, var(--color-teal), var(--color-sapphire))',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}
            >
              <Users size={18} color="#11111b" />
            </div>
            <div>
              <div style={{ fontWeight: 700, fontSize: '0.9rem' }}>GoalTrack</div>
              <div style={{ fontSize: '0.7rem', color: 'var(--color-subtext0)' }}>Manager Portal</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '1rem', borderTop: '1px solid var(--color-surface0)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div style={{ overflow: 'hidden' }}>
              ...
              <div style={{ fontSize: '0.7rem', color: 'var(--color-subtext0)' }}>Manager</div>
            </div>
          </div>
